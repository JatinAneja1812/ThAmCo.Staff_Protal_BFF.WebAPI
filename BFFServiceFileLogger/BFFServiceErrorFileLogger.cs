...
namespace BFFServiceFileLogger
{
    public class BFFServiceErrorFileLoggerProvider : ILoggerProvider
    {
        private readonly string _filePath;
        private readonly long _fileSizeLimitBytes;

        public BFFServiceErrorFileLoggerProvider(string filePath, long fileSizeLimitBytes)
        {
            _filePath = filePath;
